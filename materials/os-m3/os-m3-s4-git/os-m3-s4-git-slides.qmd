---
aliases: [materials/OS-M3/OS-M3-S4-Git/OS-M3-S4-Git-slides.html]
...
format: 
  revealjs:
    ...
    slide-number: true
    logo: ../../../assets/logos/osc-logo.jpg
  pdf:
    geometry: 
      - top=30mm
      - left=30mm
...
Code snippets are dedicated to the public domain and licenced under a CC0 1.0 licence. With a CC0 licence users can use, modify, distribute, and sell the code snippets for any purpose, without permission or attribution. The code snippets are provided “as is”, without warranty of any kind.
:::
...
**Creator**: Von Grebmer zu Wolfsthurn, Sarah (![](images/orcid-id-icon-16x16.png){fig-alt="orcid logo"}[0000-0002-6413-3895](https://orcid.org/0000-0002-6413-3895))
...
**Consultant**: Edelsbrunner, Peter (![](images/orcid-id-icon-16x16.png){fig-alt="orcid logo"}[0000-0001-9102-1090](https://orcid.org/0000-0001-9102-1090))
...
<div style="display: flex; align-items: flex-start; gap: 0.5em;">
  ...
  <div style="flex: 1; text-align: center;">
    <img src="images/09-manuscript-version-mess.png" style="width: 70%;" />
  </div>
...
![](images/10-coffee-spill-gender-neutral.png){fig-align=center width=30% fig-alt="hardware fails"}
...
![](images/11-confused.png){fig-align=center width=20% fig-alt="hardware fails"}
...
![](images/12-crashed-pc.png){fig-align=center width=30% fig-alt="burning PC"}
...
## ![](images/chart-bar.png){width=1em} Who is familiar with these problems?
:::
...
:::
::: {.content-visible when-format="pdf"}
![](images/chart-bar.png){width=3em} 
:::
...
:::
::: {.content-visible when-format="pdf"}
## ![](images/chart-bar.png){width=1em} 
:::
...
![](images/06-git-logo.png){fig-align=center width=10% fig-alt="git logo"}
...
::::: columns
::: {.column width="30%"}
![](images/05-github-logo.png){fig-align=center width=60% fig-alt="github logo"}
:::
::: {.column width="70%"}
::: {.fragment}
::: {.callout-note}
...
![](images/07-git-github-workflow.jpg){fig-align="center" width=600 fig-alt="Git - GitHub workflow"}
...
:::
::: {.column width="50%"}
![](images/ssh-key.png){fig-align="center" width=500 fig-alt="Add SSH key"}
:::
::::
...
![](images/add-ssh-key.png){fig-align="center" width=600 fig-alt="Configure SSH key pair for PC"}
...
![](images/project-screen1.png){fig-align="center" width=600 fig-alt="Create RStudio Project"}
...
![](images/04-create-new-rproject.png){fig-align="center" fig-alt="new R project"}
...
![](images/project-screen3.png){fig-align="center" width=700 fig-alt="Create new repo"}
...
![](images/project-files.png){fig-align="center" width=600 fig-alt="Project files"}
...
<div style="text-align:center;">
  <a href="assets/example-data.csv" download>
...
mydata = read.csv("example-data.csv")
...
![](images/file-list.png){fig-align="center" width=600 fig-alt="Directory files"}
...
![](images/git-pane.png){fig-align="center" width=600 fig-alt="Git pane"}
...
![](images/git-pane-added.png){fig-align="center" width=600 fig-alt="Git staging"}
...
![](images/08-commit-rstudio.png){fig-align="center" width=500 fig-alt="Git commit"}
...
![](images/first-commit.png){fig-align="center" width=600 fig-alt="First git commit"}
...
![](images/git-commit-message.png){fig-align="center" width=600 fig-alt="Git feedback"}
...
![](images/git-changed.png){fig-align="center" width=600 fig-alt="git staging"}
...
![](images/git-diff.png){fig-align="center" width=600 fig-alt="git difference"}
...
![](images/new-repo.png){fig-align="center" width=600 fig-alt="new GitHub repository"}
...
![](images/new-repo-name.png){fig-align="center" width=200 fig-alt="new GitHub repository"}
...
![](images/github-git-commands.png){fig-align="center" width=200 fig-alt="quick setup GitHub"}
...
![](images/git-more-shell.png){fig-align="center" width=200 fig-alt="RStudio new terminal"}
...
![](images/first-push-confirm-identity.png){fig-align="center" width=200 fig-alt="Confirm connection with GitHub"}
...
![](images/staged-readme.png){fig-align="center" width=200 fig-alt="Stage README file"}
...
![](images/readme-commit.png){fig-align="center" width=200 fig-alt="Commit README file"}
...
![](images/git-push.png){fig-align="center" width=200 fig-alt="Push README file"}
...
- [ ]  Download the practise-data.csv file and save it in your project folder

<div style="text-align:center;">
  <a href="assets/practise-data.csv" download>
    <button style="padding:10px 20px; border:none; border-radius:8px; background:#007ACC; color:white; font-size:20px; cursor:pointer;">
...
![](images/13-git-in-case-of-fire.png){fig-align=center}
...
- **How often should I commit?** Commit early and often after a "work" unit (whatever this could mean for your specific work), better to committ too often that too little. See here for more general guidelines: [https://www.simplethread.com/what-makes-a-good-git-commit/](https://www.simplethread.com/what-makes-a-good-git-commit/).
