---
aliases: [materials/OS-M3/OS-M3-S6-Quarto/OS-M3-S6-Quarto-slides.html]
...
![You can find both *Render on Save* and *Manual Rendering* at the top of your workspace.](images/01-render.png){fig-alt="A screenshot of a menu bar in an RStudio workspace with red rectangles highlighting the 'Render on Save' checkbox and 'Render' button."}
...
:::::: columns
::: column
![](images/02-quarto-setup.png){fig-alt="An image of the drop-down menu in RStudio's File tab highlighting the 'New File' option and then the selection of the 'Quarto Document' option."}
...
:::::: columns
::: column
![](images/03-quarto-setup.png){fig-alt="This image shows the setup screen when creating a New Quarto Document for actions such as setting the title, author, and output format."}
...
- There are multiple ways to insert **code chunks**:
  ...
  - Simply click the green *Insert Code Chunk* button on the toolbar ![](images/code-chunk.png){fig-alt="A screenshot of an RStudio toolbar with a red rectangle highlighting the 'Insert a new code chunk' action button which is a green square with a the letter C in its center and a green plus icon to its top-left."} 
...
![](images/04-code-display.png){fig-alt="A screenshot of a summary table displaying the weight, time, and diet information for chicks. Below the table is a line graph with multiple colorful lines. Red rectangles highlight the R code for both the summary table and graph."}
...
![](images/05-chick-pic.png){width="20%" fig-align="left" fig-alt="An image of 3 yellow chicks sitting in the grass."}

-   Image with a caption below it: ```![caption](path/image.png)```

![This is a caption about three yellow chicks in the grass.](images/05-chick-pic.png){width="20%" fig-align="left" fig-alt="An image of 3 yellow chicks sitting in the grass."}
...
[![Click on the image to access a published study on broiler chicks.](images/05-chick-pic.png){width="40%" fig-align="left" fig-alt="An image of 3 yellow chicks sitting in the grass."}](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0127819)
...
-   [ ] <a href="images/05-chick-pic.png" download>Click this link to download the image</a>
...
```{.textbox}
![No chicks were harmed in the making of this website.](images/05-chick-pic.png)
```
...
![](images/06-zotero-logo.png){width="80%" fig-alt="An image of Zotero's logo. The letter Z in the color red is placed in the center of a white square with rounded edges. The lower-right corner is lifted to reveal written words underneath and four colored tabs are placed around the square."}
...
![](images/07-zotero-toolbar.png){fig-alt="A screenshot of an RStudio toolbar with red rectangles highlighting the 'Source/Visual' mode options and the 'Insert' function."}
...
:::::: {style="display: flex; gap: 1em;"}
::: {style="flex: 0.5;"}
![](images/08-zotero-library.png){fig-alt="A screenshot of the dropdown menu under 'Insert' with a red rectangle around the 'Zotero/My Library' option."}
...
![](images/09-zotero-insert.png){fig-alt="An image showing the citation key 'pauwels2015' and a red rectangle highlighting the 'Insert' option."}
...
![](images/10-zotero-intext.png){fig-alt="An image showing the citation key 'li2016' and a red rectangle highlighting the ticked In-text checkbox."}
...
:::
::: column
![](images/11-zotero-review.png){fig-alt="A screenshot showing two sentences about chick body weight including citations and a bibliography below."}
...
:::::: columns
::: column
![](images/12-gitbash-terminal.png){fig-alt="The 'Terminal Options...' selection is highlighted with a red rectangle under the options in Terminal within RStudio."}

:::
::: column
![](images/13-gitbash-terminal.png){fig-alt="A screenshot displaying the 'Git Bash' option being selected from the dropdown menu under 'New terminals open with:'."}
...
![](images/14-terminal-cd-command.png){width="50%" fig-alt="Screenshot of the Terminal with the 'cd' command setting the directory to 'Quarto'."}
...
:::
::: {style="flex: .65;"}
![](images/15-gitpages-settings.png){fig-alt="A screenshot of the settings on a GitHub repository where the action of changing 'None' to 'main' branch is highlighted with red rectangles."}
...
:::
::: {style="flex: .65;"}
![](images/16-gitpages-settings.png){fig-alt="A screenshot of the settings on a GitHub repository where the action of changing '/root' to '/docs' is highlighted with red rectangles."}
...
<div style="text-align: center;">
  <a href="assets/os-m3-s6-quarto-activity-sheet.pdf" download 
     style="background-color:#007ACC; color:white; padding:8px 14px; border-radius:4px; 
            text-decoration:none; font-weight:500;">
...
- <a href="assets/os-m3-s6-quarto-activity-sheet.pdf" download>Downloadable activity sheet as a PDF</a> to learn additional Quarto features, designed with slightly less guidance so that students are encouraged to apply their knowledge and skills more independently. 
