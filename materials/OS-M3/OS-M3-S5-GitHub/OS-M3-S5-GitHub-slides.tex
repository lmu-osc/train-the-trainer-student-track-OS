...
\textbf{Speaker Notes}: The Creative Commons Attribution--ShareAlike 4.0
...
(\pandocbounded{\includegraphics[keepaspectratio]{images/ORCID-iD_icon_16x16.png}}\href{https://orcid.org/0009-0006-3725-6730}{0009-0006-3725-6730})

\textbf{Reviewer}: von Grebmer zu Wolfsthurn, Sarah
(\pandocbounded{\includegraphics[keepaspectratio]{images/ORCID-iD_icon_16x16.png}}\href{https://orcid.org/0000-0002-6413-3895}{0000-0002-6413-3895})

\textbf{Consultant}: Ihle, Malika
(\pandocbounded{\includegraphics[keepaspectratio]{images/ORCID-iD_icon_16x16.png}}\href{https://orcid.org/0000-0002-3242-5981}{0000-0002-3242-5981})

\textbf{Speaker Notes}: Speaker notes may act as a guiding script for
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Prerequisites}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
These are important steps to be able to understand what will be covered
in this submodule and complete the exercises. Usually, the instructor
will set up the practice repository, but learners completing this lesson
independently may also create it themselves.
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Now you have your practice repository!}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: We need a main repository where we will combine
or merge all our contributions into one project. To have all the
...
submodule}\label{questions-from-the-previous-submodule}

Any remaining questions about the most recent content and/or practical
exercises?

\textbf{Speaker Notes}: Are there any questions from what was discussed
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/00_Particify_Survey_Rooms.png}}
\end{center}

\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Starting Survey}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: Looking at the results from this small survey,
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{GitHub and Open Science}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: So far, you have built up your R skills from
...
\textbf{Speaker Notes}: By the end of this session, you should feel
...
\textbf{Speaker Notes}: This session will be an introduction on how to
...
\textbf{Speaker Notes}: Now let us define these key terms, even if for
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Sound familiar?}, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: For many projects, researchers working
...
\pandocbounded{\includegraphics[keepaspectratio]{images/01_GitHub_Logo.png}}
...
\textbf{Speaker Notes}: GitHub is a collaborative hub for open and
...
\pandocbounded{\includegraphics[keepaspectratio]{images/02_Collab_Code.png}}
...
\textbf{Speaker Notes}: Collaborative coding means that a whole team can
contribute to the same project in real time where everyone can edit,
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/03_GitHub_Workflow.png}}
\end{center}

\textbf{Speaker Notes}: Here is what a typical workflow using GitHub
looks like:
...
\textbf{Speaker Notes}: Now let us go through each of the steps in the
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{What is meant by ``\textbf{repo}'' here?}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: Go to the main repository of the project we will
be using for today, e,g., the repository that I provided you with today.
Click the link to be redirected to the repository on GitHub.
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/fork-button.png}}
\end{center}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Something does not look the same?}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: On the repository, find the toolbar at the top
...
\textbf{Speaker Notes}: It takes you to a new page where you will change
the `owner' to your GitHub account, leave the repository name as is and
then click the green ``Create fork'' button at the bottom.
...
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/fork-process.png}}

\textbf{Speaker Notes}: When you click on the drop-down arrow next to
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important difference: Forking vs.~cloning}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: To work on your copy or version of the project,
clone it to your personal device. When you clone the repo, it takes the
project from GitHub and downloads it onto your personal device so now
you have an offline version of the project to work on. How does this
contribute towards collaboration? You can now have a copy of the project
files on your local device that's still connected to the online
...
\textbf{Speaker Notes}: Let us practice this using the forked repository
you just made. In your fork, find the green ``Code button''. Once you
find that, it will most likely be on the HTTPS tab, so we need to click
on the SSH tab instead and copy the URL given there.
...
\textbf{Speaker Notes}: - Now let's switch to RStudio where we can use
...
\textbf{Speaker Notes}: We need to select ``Version Control'' to connect
RStudio directly to the GitHub repository and work with version-tracked
code. Then, we select ``Git'' to clone the project directly from the
GitHub repository.
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Placing this project in a new folder}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: Remember the URL we copied from the SSH tab? Now
we need to paste it under ``Repository URL''. If you've created a folder
with a Git database for a previous lesson, make a new one for this. When
you make a new folder, click ``Browse\ldots{}'' and select that folder.
Each folder should have it's own Git database. Next, when you hit
``Create Project'', you'll need to enter your password.
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/files-tab.png}}
\end{center}

Now, when you click on the ``\texttt{Files}'' tab in \textbf{RStudio},
you should see all the files from the main repository.

\textbf{Speaker Notes}: And that's it! You should now have the files
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Avoiding merge conflicts}, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: A commit is like taking a snapshot of your
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/copy-params_tmpl.png}}
\end{center}
...
\textbf{Speaker Notes}: We are still in RStudio. In the `Files' tab,
...
\textbf{Speaker Notes}: You'll be prompted to give the copied file a
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/edit-file.png}}
\end{center}
...
\textbf{Speaker Notes}: In this exercise, each person will edit their
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/stage.png}}
\end{center}
...
\textbf{Speaker Notes}: After this, save the file as normal by going to
``File'' and then clicking ``Save''. In the Git tab on RStudio, tick the
checkbox next to your copied file under the ``Staged'' column. Staging a
commit means you're selecting which specific changes you want to include
in your next commit. Then click the ``Commit'' button.
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/commit.png}}
\end{center}
...
\textbf{Speaker Notes}: You should leave a message to accompany your
...
\textbf{Speaker Notes}: You have successfully made a contribution by
...
\textbf{Speaker Notes}: The next step after making your changes and
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/push-rstudio.png}}
\end{center}
...
\textbf{Speaker Notes}: The changes you made are just on your local
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/push-github.png}}
\end{center}

\textbf{Speaker Notes}: If all went well, you will see a pop up box with
a message like this one to let you know the changes were successfully
pushed to the remote repository. An additional way to make sure your
changes were pushed, refresh your GitHub repository webpage and check to
see if the file you copied is now appearing. The commit message should
also appear next to it on GitHub.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{Push changes}\label{push-changes-2}

\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important step: refresh the page}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: Now go back to your forked repository on GitHub
and refresh the page. This is an important step to confirm that the file
together with the commit message are appearing and to update your fork
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Pre-break quiz}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
the things we covered in the first part of this lesson. Scan the QR code
again and find the quiz titled ``Os-M3-S5-Github-prebreak\_quiz''. This
quiz has a few simple recap questions about what we've learned so far
about using GitHub for collaboration on projects. The goal isn't to test
you, but to help you reflect on what you've learned and to see if
anything needs a bit more clarification.
...
\textbf{Speaker Notes}: After pushing your changes to the remote
...
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/pull-request-button.png}}
...
\textbf{Speaker Notes}: Now we are working in the remote repository on
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/create-pull-request.png}}
\end{center}
...
\textbf{Speaker Notes}: Check the settings to ensure the ``base
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/created-pull-request.png}}
\end{center}
...
\textbf{Speaker Notes}: Add a message describing the changes you made.
...
\textbf{Speaker Notes}: Now that the changes have been made and you
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{What's happening here?}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: If you are the owner of the repository and will
merge files, you must first click on the ``Pull requests'' tab and
...
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/comment-and-merge.png}}
...
\textbf{Speaker Notes}: If everything looks fine, go back to the ``Pull
request'' tab, leave a comment (this is optional), and click on ``Merge
pull request'' then ``Confirm the merge''. And now that file that was
inspected is now incorporated into the project files in main repository.
...
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/pull.png}}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{What should I see?}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: Let us see how all the contributions are
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/knit.png}}
\end{center}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{What does \texttt{Knit} do?}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: After pulling everyone's changes, the owner
...
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/plot.png}}
...
\textbf{Speaker Notes}: When the owner knits the R Markdown file, an
...
\textbf{Speaker Notes}: Now that we know what to do, let's see it in
...
\textbf{Speaker Notes}: Even after you pushed your changes and it was
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\texttt{git\ checkout}}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: If you want the changes or updates to appear on
your fork on GitHub, you need to first pull the updates from the main
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{How to properly format this command?}, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\textbf{Speaker Notes}: Next, we type this command to pull the original
repository and branch we wish to obtain locally. Follow the format but
replace ``ORIGINAL\_OWNER'' and ``ORIGINAL\_REPOSITORY''. Here's an
example of what it looks like when these two commands are executed
successfully.
...
\textbf{Speaker Notes}: Let's look at this example: first there is the
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S5-GitHub-slides_files/mediabag/final-push.png}}
...
\textbf{Speaker Notes}: Earlier we merged some new R files containing
...
\textbf{Speaker Notes}: Great job, you have completed a full GitHub
...
\textbf{Speaker Notes}: Here is a quick recap of the full GitHub
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/04_Recap_Activity.png}}
\end{center}

\emph{Fill in the missing words with the actions we learned today!}

\textbf{Speaker Notes}: Let's revist this diagram we saw at the
...
\textbf{Speaker Notes}: Now you can download the original image and
check your answers.
...
\textbf{Speaker Notes}: So, you have seen the full workflow in action
...
\textbf{Speaker Notes:} Let's think about a take-home message from
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{What is a \textbf{terminal}?}, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Final survey}, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, toptitle=1mm, arc=.35mm, leftrule=.75mm, left=2mm]
...
where we stand in our understanding of using GitHub and what we can
...
\textbf{Speaker Notes}: Now that you've completed both the pre- and
