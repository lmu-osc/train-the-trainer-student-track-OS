...
**Consultant**: Ihle, Malika (![ORCID Logo](https://orcid.org/sites/default/files/images/orcid_16x16.png) [0000-0002-3242-5981](https://orcid.org/0000-0002-3242-5981))
...
| A Practice Repo | Fork the [LMU OSC Collaborative-RStudio-GitHub repository](https://github.com/lmu-osc/Collaborative-RStudio-GitHub/tree/main) to set up a practice repository for the exercises in this lesson | See next slide

</div>

<div style="color:red; font-size:50%;">
Beth: added the last pre-req
</div>
...
**Instructor Notes**: These are the prerequisites for this submodule. Before you get started on this submodule with your audience, you need to ensure that the audience fulfills these criteria. In this session, we will assume that your audience has basic R skills and completed the corresponding workshops. We also assume familiarity with Git and that the audience has also completed that submodule. We also assume that, through the previous workshops, participants have downloaded and installed R and RStudio on their local machines. Lastly, the instructor should create a fork of the LMU OSC Collaborative-RStudio-GitHub repository. This will be the main repository for the class session and activities (that is, this forked repository is the repository that the students will fork and where the contributions will go when merged).
:::
...
::: {.notes}
**Speaker Notes**: Now let's define these key terms, even if for now they are a little abstract. <br>
...
- The research and analysis materials used in the project are hosted and shared publicly or privately to support transparent collaboration.
...
<div style="font-size: 0.7em;"> Beth: I agree, I also changed the word "code" from the previous slide to "project materials" 
</div>
...
- **Collaborative coding** is just one of the ways a team or group can work together on a single project. 
- It involves multiple developers working on the same codebase, allowing everyone to collectively contribute, review, and make improvements. 
...
</div> <div style="font-size: 0.7em;"> Beth: seeing that the activity itself is a coding project and they're working with R, I would say keep the name but I def agree that it limits the idea of collaboration on github to *just* coding... I'll add something in. Thoughts? 
</div>
...
**Instructor Notes**: This is where the practice repo you had set up comes in. The students will make a fork of the one you previously forked from the OSC GitHub account.
:::
...
Here's a link to the main repository: [insert a title of the link here](insert the link to the practice reposiory here)
...
**Instructor Notes**: Provide students with the name or link to your forked repo created for this session. Replace the information in the first line with the practice repository. Make a title for the link (for e.g., "Practice Repository for Collaborative Coding") in the square brackets and then copy and paste the url link to the practice repository in the brackets. This way, the students can easy navigate to the practice repository they must then fork in the next slide. 
:::
...
Note, **the screenshot may not match exactly** because you may be forking from your instructor's GitHub instead of from the practice repo from 'lmu-osc'.
:::
...
</div> <div style="font-size: 0.7em;"> Beth: I like this idea
</div>
...
</div> <div style="font-size:50%;"> Will do 
</div>
...
**Instructor Notes**: You can remind students that this does not mean their changes will show up on GitHub, that requires an additional step. But this does mean their activity and changes were recorded in the project history. 
:::
...
Beth: added & made that part on the slide bold too
</div>
...
**Instructor Notes**: The instructor (that is, the owner of the main repository) will perform this task to pull the changes made by the students into the main repo. 
:::
...
- Several actions in collaborative coding on GitHub can also be performed directly using **Git commands in a Terminal** instead of using the functions in RStudio. 
