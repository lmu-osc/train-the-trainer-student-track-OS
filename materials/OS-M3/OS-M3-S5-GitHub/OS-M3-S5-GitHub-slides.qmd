...
- [Click here to go to LMU OSC's Collaborative-RStudio-GitHub repository](https://github.com/lmu-osc/Collaborative-RStudio-GitHub/tree/main)
...
You have copied all the materials from the LMU OSC Collaborative-RStudio-GitHub repository needed to do this session's activities with your **own GitHub account**. This fork will be referred to as the **main repository** from here on and is the repository your **students** will work on.
:::
...
First, make a new folder on your device. Then, you can change the path under "`Create project as subdirectroy of:`" to locate this Git repository in that new folder. We are making a new folder because it is advisable that each folder has its own Git database.
:::
...
![This is an example](https://raw.githubusercontent.com/lmu-osc/Collaborative-RStudio-GitHub/main/assets/final-push.png){fig-alt="A screenshot of an RStudio terminal showing the command ‘git push’ with a successful push to the GitHub repository."}
...
- Several actions in collaborative coding on GitHub can also be performed directly using **Git commands in a Terminal**. 

::: callout-tip
## What is a **terminal**? 

It's a text-based tool where you can type commands to run programs such as Git.
:::

Here is an activity sheet to learn and practice Git commands:
...
<div style="text-align: center;">
  <a href="assets/OS-M3-S5-GitHub-activity_sheet.pdf" download 
     style="background-color:#007ACC; color:white; padding:10px 16px; border-radius:6px; 
            text-decoration:none; font-weight:600;">
    Download the Git Hub activity sheet
  </a>
</div>
