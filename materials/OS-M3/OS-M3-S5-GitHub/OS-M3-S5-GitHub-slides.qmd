...
<div style="font-size: 0.7em;">
<span style="color:red;">Trying to take the student perspective: do you think sollaborative coding is too strict in the sense? You mention working on the same project, would that be a more concrete framework and have collaborating on code as an extra? What applies more to students? I am aware this is how the tutorial is called etc., but do you think this name still fits for our student audience? Thoughts?
</div>
...
<div style="font-size: 0.7em;">
<span style="color:red;">My thought was to push this one to the beginning after the prerequisites? What do you think?
</div>
...
<div style="font-size: 0.7em;">
<span style="color:red;">Can you make a slide (maybe before this practical bit) with either the link to our LMU OSC practise repo or a placeholder for the instructor to add their link to the repo?
</div>
...
::: {.notes}
**Speaker Notes**: Go to the main repository of the project we will be using for today, e,g., the repository that I provided you with today. Find the toolbar at the top that is next to the name of the repository and click "Fork". 
...
**Instructor Notes**: If students are confused as to which password is required: it is the password for their individual GitHub accounts.
:::
...
<div style="color:red; font-size:50%;">
Maybe add instructor notes here that this is now up to the instructor to handle?
</div>
...
<div style="color:red; font-size:50%;">
Maybe add instructor notes here?
</div>
---
...
::: {.notes}
**Speaker Noes**: Great job, you have completed a full GitHub collaboration cycle. You forked the main repository, made and committed your own changes, pushed them for review, and finally pulled the merged updates back into your local copy. This is the same workflow used in real research collaborations.
:::
...
<div style="color:red; font-size:50%;">
This slide and the ones before are really nice!
</div>
...
<div style="color:red; font-size:50%;">
Add instead of xx to that student see the difference.
</div>
