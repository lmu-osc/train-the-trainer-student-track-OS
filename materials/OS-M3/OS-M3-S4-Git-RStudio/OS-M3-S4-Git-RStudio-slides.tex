...
\urlstyle{same}
\hypersetup{
  pdftitle={Reproducible Workflows in RStudio with Git},
  pdfauthor={Luz Sanchez Steinhagen},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Reproducible Workflows in RStudio with Git}
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, breakable, colback=white, titlerule=0mm, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Prerequisites}, toprule=.15mm, leftrule=.75mm]
...
These are the \textbf{speaker notes}. You will a script for the
presenter for every slide. In presentation mode, your audience will not
be able to see these speaker notes, they are only visible to the
presenter.

There are also \textbf{instructor notes}. For some slides, there will be
pedagogical tips, suggestons for acitivities and troubleshooting tips
...
\item
  ...
  prior knowledge about the sumodule's topic.
\item
  Use free survey software such as or other survey software (particify,
  formR) to establish the following questions (shown on separate
  slides):
\end{itemize}
...
Workspace}\label{dealing-with-the-workspace}
...
\subsection{Commenting Code and
Documentation}\label{commenting-code-and-documentation}
...
\subsection{Version Control (Section
Header)}\label{version-control-section-header}
...
\subsection{Git Vocabulary}\label{git-vocabulary}
...
\tightlist
\item
  \textbf{Aim}: Place the topic of the current submodule within a
  broader context.
\item
  Remind students what you are working towards and what the bigger
  picture is.
\end{itemize}
...
\subsubsection{Covered in in this
session}\label{covered-in-in-this-session}
...
Base yourself on conceptual change theory and examine exisiting concepts
in relation to some key terms. Re-examine formation of new concepts at
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, breakable, colback=white, titlerule=0mm, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important with Title}, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, breakable, colback=white, titlerule=0mm, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip with Title}, toprule=.15mm, leftrule=.75mm]
...
\item ~
  \subsection{Use free survey software such as or other survey software
  (particify, formR) to establish the following questions (shown on
  separate
  slides):}\label{use-free-survey-software-such-as-or-other-survey-software-particify-formr-to-establish-the-following-questions-shown-on-separate-slides}
\end{itemize}
...
\pandocbounded{\includegraphics[keepaspectratio]{OS-M3-S4-Git-RStudio-slides_files/figure-pdf/unnamed-chunk-1-1.pdf}}
