...
Changes made during final review - nice work Beth!
...
## TO DO slide - please DELETE at the end

- finalise the survey slides
- solve this warning message (pops up in background jobs when rendering the slides): Warning message:
In get_engine(options$engine) :
  Unknown language engine 'text' (must be registered via knit_engines$set()).
pandoc 
- Provide reference for conceptual change theory and add to the instructor notes. Also briefly in once sentence give the context of this theory and why it is useful when examining the key terms and definitions. 
- Slide 22: When you get to creating and setting up the Quarto Document, can you add if you want the learner to accept the YAML defaults in the interface and change the YAML in the doc later of if you want the learner to already input a title and author in the interface prior?
- Sldie 25: Add explanation to speaker notes about format:
  html:
    code-fold: false
    toc: true when you talk about exercise 2
- Somewhere before slide 19 and slide 32 there is an issue with a div ::: (warning message when rendering), can you find it an fix it? Could be a missing blank line after the ending ::: or a space after ::: at the end or something like this? Maybe separate those slides from the rest with the yaml and run section by section?
- Slide 37: provide the solutions to Exercise 6 in the instructor notes or separately?
- Slide 38: insert a recap slide with the green ticks at the end to show people the process in terms of learning gooals?
- Slide 42: complete the slide
- slide 52: add screenshot with solution for the yaml header, since it is so sensitive to indents etc. Or add the solution for the instructors only?
- Slide 53: you say that a reference list is automatically created at the end of the document - is this just for the visual editor mode? Else you need to specifically set the reference section with ```::: etc right?```
- Slide 60: add what Quarto pub is to instructor notes
- Slide 69: for the quarto render part, did you want to add some troubleshooting aspects in the instructor notes? An idea of what could go wrong in your experience?
- Homework assignment and cheatsheet: use the latest OSC-FORRT logo where the two logos are the same size next to each other (like in the slides)
---
...
- Move within the framework of the conceptual change theory and examine existing concepts in relation to some key terms. Re-examine formation of new concepts at the end of the lesson. 
:::
...
**Instructor Notes**: Frame Quarto as the solution to the problem of hard-to-read papers and bodies of work that attempt to integrate text, code, and media with no standard format. This slide demonstrates how Quarto separates source from presentation. The left side shows what the author writes, while the right side shows what the reader sees as a rendered Quarto output.
:::
...
::: {.notes}
**Speaker Notes**: Quarto documents can be rendered either manually or automatically when you save your work.
...
::: {.notes}
**Speaker Notes**: Quarto documents can be created and edited in either Source mode or Visual mode. Both modes work with the same file, but they provide slightly different experiences:
...
::: {.notes}
**Speaker Notes**: Let us begin with the practical bits! To get started with Quarto in RStudio, the first step is to create a new Quarto document. You do this by going to 'File' on the toolbar and selecting 'New File'. Here, you see options for both Quarto Document and Quarto Presentation. **What's the difference between a Quarto Document and Quarto Presentation**?
...
::: {.notes}
**Speaker Notes**: Authoring is combining the YAML header with the markdown text. This means that what you do to customize, add to, and develop your document is the process of 'authoring.'
...
- Embedding **media**, e.g., images or videos
:::

::: callout-note
## Commonly used authoring features

If you want to know more, here is a <a href="https://quarto.org/docs/authoring/markdown-basics.html">link</a> (https://quarto.org/docs/authoring/markdown-basics.html) for commonly used markdown syntax for additional authoring features.
:::
...
- [ ] Copy and paste the text above and place the cursor at the end of the sentence. This wil be the spot where you add your citation.
...
- [ ] Add the citation to your Zotero Library
- [ ] Copy and paste the text below,  then place your cursor at the beginning of the sentence:
...
**What is publishing with Quarto?** <br>
...
Here is a <a href="https://quarto.org/docs/publishing/index.html">link </a> (https://quarto.org/docs/publishing/index.html) for a list of publishing services and more information!
:::
...
<a href="https://lmu-osc.github.io/code-publishing/intro.html">Click here </a> (https://lmu-osc.github.io/code-publishing/intro.html) for the LMU OSC page on all you need to know about sharing, copyright, best practices and more.
:::

::: {.notes}
**Speaker Notes**: As practitioners of open research, sharing your work is more than just making it available. It's also about being responsible and following certain standards. There are legal aspects of sharing that we should consider such as: 
...
<div style="font-size: 0.6em;">
<span style="color:red">From SvG: Add references here</span> Beth: should I cite the Quarto Website? SvG: Yes,I would add it here!
</div> 
...
<div style="font-size: 0.6em;">
<span style="color:red">From SvG: Still to do right?</span> Beth: yes SvG: This is now all complete right?
</div> 
