...
<div style="font-size: 0.6em;">
<span style="color:red">From David: Do these key terms fit?</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: For longer topics or multiple subchapters, I created these level 1 slides. Let me know if this is okay or if I used the level 1 slides too often.</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: The text and image are too small. Should I crop the image to show only the relevant part of the RStudio interface, or should I split the content into two slides?</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: Are my tasks generally appropriate? I have also decided to present the solutions immediately following each task. This ensures that everyone is on the same page before moving on to next topic.</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: I used R part 1 and its subchapters as a guide. But do we really need the take-home message here? It feels redundant after "## The Big Picture: R in Data Science", "The Power of R: What comes next?" etc. and since "## Learning goals: Check-In" is the next slide.</span>
</div>
