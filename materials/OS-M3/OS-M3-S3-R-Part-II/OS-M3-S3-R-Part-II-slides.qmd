...
<span style="color:red">From David: Here I'm not sure how if I split up the contributions correctly. Also, I don't know all the ORCID IDs. SARA COMMENT: Name order is a discussion for all authors to have. Reminder to acknowledge Luz [Caterina Luz Sanchez Steinhagen](https://orcid.org/0009-0006-4783-1110), Elizabeth's orcid is [Elizabeth Waterfield](https://orcid.org/0009-0006-3725-6730). You can add me as reviewer: [Sara Lil Middleton](https://orcid.org/0000-0001-5307-8029)  </span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: Do these key terms fit? SARA COMMENT: Yes I would say these are the four main key terms you refer to in these slides.</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: For longer topics or multiple subchapters, I created these level 1 slides. Let me know if this is okay or if I used the level 1 slides too often. SARA COMMENT: I would say for flow, stick to level 2 headings, as level 1 creates a blank page before. in citation politics I used level 2 headings and added an image to create the subchapters feel. https://lmu-osc.github.io/train-the-trainer-student-track-pedagogy/materials/PMM-M4/PMM-M4-S3-Citation-Politics/PMM-M4-S3-Citation-Politics-slides.html#/section-1-introduction-to-citations </span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: The text and image are too small. Should I crop the image to show only the relevant part of the RStudio interface, or should I split the content into two slides? SARA COMMENT: Agree, image a bit too small. I would first try out the cropped image and see how that looks. </span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: The text and image are too small. Should I crop the image to show only the relevant part of the RStudio interface, or should I split the content into two slides? SARA COMMENT: 1. I would try out the cropped image. 2. Check you are referring to the R studio environment in consistent way to R part 1, I would call the "file" pane "output" to be consistent with R studio guidelines. https://docs.posit.co/ide/user/ide/guide/ui/ui-panes.html .</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: For clarity in "Alternatively...": mention packages tab in the output pane in the bottom right of RStudio.</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: Are my tasks generally appropriate? I have also decided to present the solutions immediately following each task. This ensures that everyone is on the same page before moving on to next topic. SARA COMMENT: Yes I think so</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: To provide more context to learners, I would add a sentence in the presenter notes about the data they will be working with. e.g. this is an example data set on X. </span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: I would add a note on this slide about codebooks and link out to our training material on data dictionaries: https://lmu-osc.github.io/data-documentation-validation-R/02-data-dictionaries/page1.html</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: Presenter notes: for consistency and in line with RStudio guidelines, change "Plots pane" to  "output pane" .</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: Presenter notes: I would copy over description of histogram (e.g. "Looking at the plots..." from previous slide to the presenter notes in this slide, to better match what the slide contains.</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: To be consistent with previous practical exercise formats, I would consider having a solutions slide after the exercise and copy the presenter notes about the answer over to the solutions slide.</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: I like this little check in slide! For clarity, I would add a space between the 3 points labelled as "we did this!" and points 4 - model and 5 - communicate to signpost this differentiation .</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: For learners that would be interested in finding out more, you can add hyperlinks to ggplot2 and shiny.</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: I would rephrase AI point to be a bit more cautious: Perhaps use language like "widespread" "helpful" rather than "standard". The caveat about "foundational understanding.." you have here is important! </span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: For instructors it would be helpful for them to have a guideline time allocation for this think-pair-share activity. </span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red"> SARA COMMENT: I would link OSC R tutorial https://lmu-osc.github.io/introduction-to-R/ here too.</span>
</div>
