...
## Feedback Slide Sarah - delete at the end

- I saw your comment for the QR code for practical exercise 3; particify (the software we use for generating quizzes and surveys etc) has permanent QR codes - I would perhaps eliminate the QR code and keep the hyperlink as well as the actual link in case learners cannot click the link etc, they could look for it manually in their browser?

- on the final words slide you mention this: - **AI is a helpful tool:** Using AI to write code, navigate complex documentation, or troubleshoot errors is becoming increasingly widespread. However, the foundational understanding you built today is essential to verify and adapt the output. I am wondering if we would need an extra slide to perhaps tell learners about how to use AI responsibily and also specific tools for code and troubleshooting? This feels like it could be a slide deck in itself, and we are promoting it without giving examples and only highlighting the complexity in passing? Thoughts?

- additional resources slide: I would hyperline the "interactive course on R" and the provide the full link in brackets (for accessibility, also for the next bullet point)

- for accessibility: use hyperlinks, but also always the full links spelled out on the slide somewhere in case learners do not have the slides in front of them and need to manually access the links in their browser. 
...
<div style="font-size: 0.6em;">
<span style="color:red"> From David: I'm not sure if the qr code will be permanent, since I used a free online qr code generator. The url to the data is https://github.com/nickhaf/r_tutorial/tree/main/raw_data</span>
</div>
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: Is it okay how I divided the remaining content in R part 2 (it is a bit more content in the first half before the break than in the second half after the break)? SvG: to me this is good! Practical exercices, depending on the length, can be a small break too, and there are lots of those so I think you are good?</span>
</div>
...
::: incremental
<div style="font-size: 0.8em;">
- **Advanced visualizations:** Packages like [`ggplot2`](https://ggplot2.tidyverse.org/) allow you to create stunning, highly customized graphics.
- **Interactivity:** Packages like [`shiny`](https://shiny.posit.co/) let you build interactive web applications for your data.
...
<div style="font-size: 0.6em;">
<span style="color:red">From David: I used R part 1 and its subchapters as a guide. But do we really need the take-home message here? It feels redundant after "## The Big Picture: R in Data Science", "The Power of R: What comes next?" etc. and since "## Learning goals: Check-In" is the next slide. SARA COMMENT: I see your point. I would remove the check in slide and keep the slide of final takehome messages with piece of advice learners can take away. DAVID: Should I really (of all slides) remove the check in slide? I thought the check in in the beginning and at the end of a session is a typical element used in most of these quarto presentations here. SVG comment: To me the take home messages can stay (rep is good perhaps? but I would move it after the final words? I would also move the learning goal check in nefore the looking to the future part? And remove the header 1 wrapping up slide, just straight to looking to the future slide?</span>
</div>
...
- The LMU Open Science Center provides a comprehensive R tutorial: [link to the OSC tutorial](https://lmu-osc.github.io/introduction-to-R/).
