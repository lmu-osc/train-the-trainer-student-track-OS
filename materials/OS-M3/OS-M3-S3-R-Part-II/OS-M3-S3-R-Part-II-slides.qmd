...
## How to access Help in R: Method 1
...
::: {.notes}
**Presenter Notes**: Accessing the documentation is very fast. If you know the name of the function, simply type a question mark and the name in the console. For example, `?round`. 
...
## How to access Help in R: Method 2
...
::: {.notes}
**Presenter Notes**: Alternatively, you can use the search bar in the Help tab located in the bottom right pane of RStudio.
:::
...
## Reading the Documentation: Example
