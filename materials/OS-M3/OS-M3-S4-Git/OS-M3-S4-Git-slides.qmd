...
::: {.notes}
**Speaker Notes**: The basic requirements to follow these slides are a laptop or desktop with admin rights to download and install software, the latest installations of R and RStudio, the completion of the two R tutorials, the Git introductory video as well as the creation of a free GitHub account. 
...
- **Understand** the problem that could be solved by version control
...
::: {.notes}
**Speaker Notes**: These will be some key terms we will explore more today. Do not worry if some of them do not sound familiar to you yet. I want you to first write down in the next two minutes for yourselves what each of these concepts mean for you. Then, take 3 minutes to discuss with your neighbour what you have collected. Finally, let us discuss as a group.

**Instructor Notes**: Base yourself on conceptual change theory and examine existing concepts in relation to some key terms. Use the think-pair-share paradigm: 1) THINK: students first write down for themselves what they understand by these concepts. 2) PAIR: form pairs among your students and have them discuss their current understanding of these concepts. 3) SHARE: Ask for volunteer pairs to share they conclusions and thought process. Re-examine the formation of new concepts at the end of the lesson. 
...
- **Reproducible Workflows**: A reproducible workflow refers to a structured process that ensures methods can be consistently replicated by others. This means that anyone who follows the same steps, using the same data and tools, should be able to achieve the same results. Reproducibility is essential in science and research because it helps verify findings, promotes transparency, and allows others to build on your work. By creating workflows that are transparent, well-documented, and accessible, you ensure that your research is both credible and trustworthy.

- **RStudio Project**: An RStudio Project is a convenient way to organize all the files related to a specific R project in one centralized location. This includes not only your R scripts but also any data, workspace settings, history, and outputs. By creating a project in RStudio, you make it easier to maintain a consistent working environment, ensuring that everything you need is in one place. This organization is especially useful when sharing projects with collaborators or when you need to continue working on a project at a later time, as it simplifies managing dependencies and avoids issues related to missing files or incorrect paths.
...
# Realistic challenges in our work
...
![](images/09_manuscript_version_mess.png){fig-align=center width=50% fig-alt="manuscript versions"}
...
**Instructor  Notes**: We’ve all opened an old project and thought, “What was I even doing here?” Without clear records, it’s impossible to remember how results were produced or why changes were made. This is where Git comes in, because changes are tracked and years later, you see exactly what you did and why. 
:::
...
![](images/11_Confused.png){fig-align=center width=30% fig-alt="hardware fails"}
...
**Instructor  Notes**: Without version control, it’s hard to get back to a working state or see what went wrong.
Git makes this safe: you can experiment on a branch, and if it fails, simply return to the last working version.
:::
...
**Instructor  Notes**: Select the problem survey when prompted. 
:::

---

## Version control as the solution to these challenges?
...
::: {.notes}
**Speaker Notes**: Version control is a system that records changes made to files over time. It enables you to track the history of modifications, making it easy to see who changed what, when, and why. This is particularly valuable when working on code or large projects, as it helps you manage different versions, collaborate with others, and recover previous versions if something goes wrong. With version control, you can safely experiment with new changes without fear of losing important work, as you can always revert to a stable version of the project. 

**Instructor  Notes**: Take your time with this section as it explains the WHY of version control. Students should recognize their own challenges and be curious about how exactly one could overcome these challenges.  
:::
...
**Instructor  Notes**: Run the code by pressing Ctrl + Enter.  
:::
...
Next, add the given text to the file and save the file.  
