...
- **Create** an RStudio Project under version control
...
- **RStudio Project**: Way  to store all files related to one R project in one place (R scripts, files, workspace, history ..) 
