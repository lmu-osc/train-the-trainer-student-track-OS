...
:::incremental
- To **explain** the importance of citing scientific literature and citation tools
- To **familiarize yourself** with different citation formats (CSL)
- To **set up and organize** a personal Zotero library
- To **develop** a referencing workflow in Quarto and RStudio
...
Let’s imagine a bizarre example: someone claims that eating aloe vera improves your dance skills. 
...
<div style="text-align: center; margin-top: 1em;">
  <img src="images/02_citation_example.jpg" style="width:50%;" />
  <div style="font-size: 0.6em; margin-top: 0.5em;"><em>Example of a (fictional) citation.</em></div>
</div>
...
<div style="text-align: center; margin-top: 1em;">
  ...
  <div style="font-size: 0.6em; margin-top: 0.5em;"><em>Example of a (fictional) reference (list).</em></div>
</div>
...
**Accessibility Tips**:  
Verbally describe what is shown in each image for learners who may not be able to see them clearly. Allow a brief pause after each definition so learners have time to connect the text explanation with the visual example.
:::
...
:::incremental
- **Citation**: In-text, you usually mention **author and year**. <br> 
<div style="font-size: 0.8em;">  
For example: “Recent results support this view (Miller & Rossi, 2021).”
</div>

- **Reference list**: After, you provide the full **bibliographic information**: <br>
<div style="font-size: 0.8em;">  
...
::: {.notes}
**Speaker Notes**: Here are some more example citation styles.
...
::: {.notes}
**Speaker Notes**: Are there any questions at this point?
...
<div style="background-color: #f0f0f0; padding: 0.05em; border-radius: 2px; font-size: 1.2em;">
...
::: {.notes}
**Speaker Notes**:  Let us pause for a quick check-in. Take a moment to look back at the learning goals and reflect on how comfortable you feel with each one.
...
::: {.notes}
**Speaker Notes**:  Time for a short activity. Pair up and pick a paper from a database like Google Scholar. Take a look at how the citations are formatted in the text and how the reference list is structured. Notice any patterns, differences, or special features. Later, share your observations with the class. 
