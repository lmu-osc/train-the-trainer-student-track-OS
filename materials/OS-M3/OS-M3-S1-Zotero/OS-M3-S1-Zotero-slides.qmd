...
- To **navigate** using different citation formats (CSL) in Zotero.
- To **develop** a referencing workflow in MS Word.
- To **develop** a referencing workflow using Quarto.
:::

<div style="color: red; font-size: 0.6em;">
~~I think that quite a few learning goals focus on the conceptual aspect of this and just the last two are really about the practical aspect of using Zotero? Perhaps you can flip the ratio and write two goals about the conceptual part (i.e., these intro slides) and the remaining four about the tutorial? What learning goals do they use in the self-paced tutorial? When you did this, also adjust the speaker notes accordingly.~~ 
</div>
...
<div class="fragment" style="text-align: center; margin-top: 1em;">
  ...
  <div style="font-size: 0.3em; margin-top: 0.5em;"><em>Copyright: © FastArcher.</em></div>
</div>


<div style="color: red; font-size: 0.6em;">
~~Did you want to add the source here?~~
</div>
...
::: {.notes}
**Speaker Notes**: Citations are the short pointers you include directly in the text to indicate where a piece of information comes from, typically with an author name and year. Citations help you navigate to the reference list, where you can discover the complete details of the mentioned paper.

**Accessibility Tips**:  
Verbally describe what is shown in the image for students who may not be able to see them clearly. Allow a brief pause after the definition so students have time to connect the text explanation with the visual example.
:::
...
**Instructor Notes**: Keep the focus on structure rather than memorising formatting rules. Reinforce that citation styles vary across disciplines and that students should always check departmental or journal guidelines. Use this slide as a bridge to the next one, where citation formats are introduced.
...
**Instructor Notes**: Reinforce the practical benefits of citation tools using everyday student experiences. If prompted, you can briefly open the websites of each tool and navigate how each tool is unique in its features.
:::
...
::: {.notes}
**Speaker Notes**: The image shows the Zotero interface, with your saved items in the centre, collections on the left sidebar, and detailed information for each item on the right sidebar.
...
**Instructor Notes**: Use the interface image to help students recognise Zotero when they open it themselves. Let them take a minute to see the interface image to build familiarity. Clearly signal the transition to the practical tutorial, where they will actively work with the tool.

**Accessibility Tips**: Verbally describe the layout shown in the image for students who may have difficulty seeing it clearly. Reassure students that they will not need to remember details from this slide, as the upcoming tutorial will walk them through the steps at a comfortable pace.
:::
...
- **Goal**: Finish the remaining of the 'Introduction to Zotero' tutorial and its exercises at home.
- **Self-reflective questions**: At the end of the tutorial, use the following questions to assess your learning progress from the tutorial,
...
<div style="color: red; font-size: 0.6em;">
~~Make it clear that the first bullet point is a take home assignment if applicable, the second is about an in-class acitivity, that way you connect it to the next slide?~~ 
</div>
...
<div style="color: red; font-size: 0.6em;">
~~Sure for this activity! Did you want to put the instructions for this activity clearly in bold at the top or so and phrase the questions you have as questions they have to think about/bullet points? Also adjust the speaker notes to include the task instructions clearly and add a time suggestion for how long this activity should take.~~ 
</div>

**Time for an open discussion** <br>
Take a minute to think about the following prompts:
- how can Zotero support you in your upcoming projects?; 
- identify some practical benefits of using it; 
- what obstacles do you anticipate in using it consistently?

Then, we can discuss our thoughts in the classroom.
...
How could Zotero support you in your own academic work?  
What practical benefits do you see?  
And what obstacles might make it harder to use consistently?
You could also discuss among your friends in this minute.

After that, we’ll open it up for discussion for about three to five minutes. I’m interested in concrete examples — for instance, an upcoming essay where you could realistically start using it.  

There are no right or wrong answers here. The goal is to think honestly about how this tool fits — or doesn’t fit — into your current workflow.

**Instructor Notes**:  
Keep the reflection phase quiet before moving into discussion. If participation is slow, prompt with specific contexts (e.g., literature reviews, group projects, thesis preparation).
...
- Effective citation management with **Zotero** strengthens academic writing, by enabling *accuracy, consistency, and efficiency* — allowing you to focus on literature review.

:::

<div style="color: red; font-size: 0.6em;">
~~With your learning goals in mind, sharpen the formulation of these take-home messages. - should be new learning goals as per new feedback :)~~
</div>
