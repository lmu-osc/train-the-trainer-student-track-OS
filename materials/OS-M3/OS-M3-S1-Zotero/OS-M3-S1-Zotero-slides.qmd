...
## Where are we at? - might not be applicable here since it is the first submodule?
...
- *To get a brief overview of a citation tool, Zotero - rephrase*
:::
...
**Instructor Notes**: Keep this slide brief and exploratory. Avoid explaining each format in detail; the goal is awareness, not mastery. Encourage students to visually compare formats and notice recurring elements such as authors, year, title, and source. Use the exercise to prompt independent discovery and reinforce the idea that citation conventions are field-specific.
<br>
:::
...
**Citation tools** (or **reference managers**) are apps or software that help you *collect, organize, and format citations* for school papers or research. Examples include
...
- **What can they do?** Save bibliographic information *in one-click*; create in-text citation; add references *automatically*.
...
## Learning goals: Check-In - Move to the back
...
- Citations and references are how science says *“don’t just trust me, here’s where we know this from.”* 
