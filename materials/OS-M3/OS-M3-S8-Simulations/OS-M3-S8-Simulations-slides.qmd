...
- [ ] Can the prerequisites slide be finalised?
...
::: {.notes}
**Speaker Notes**: Before we move on, we’ll take a short survey. The aim here is simply to understand your current familiarity.

In the next few slides, you’ll see some questions that invite you to reflect on where you’re starting from.
This is not a test, and it is not about getting the right answers.
...
## Learning goals - SvG suggestions
...
5. **To reuse data to measure uncertainty (bootstrapping)**

6. **To contribute to open science (transparency)**
:::
...
5. Simulations can also be used to measure uncertainty through techniques like resampling or bootstrapping. Here, we repeatedly reuse the data we already have to see how much our results might vary.

6. Another important reason simulations are used in research is their connection to open science. When we work with simulations, we can share the exact code and steps we used to generate and analyse the data. This means others can rerun the same simulation and see how the results were produced, which supports transparency.

**Instructor Notes**: Emphasize intuition over formal definitions here; the goal is to help learners develop a “feel” for variability and probability. If the students are gaining a basic understanding, you can move over to more technical explanations or terms. Feel free to present some real-life research examples you may have encountered.
...
<div style="font-size: 0.5em; color: red;">
You mention real-life examples, can you give some for the speaker notes in the previous slide? Perhaps already from the tutorial? Then delete this slide
</div>
...
**Instructor Notes**: Encourage brief reflections rather than detailed discussions. Ask students to self-assess quietly or with a quick show of hands. Invite a few questions or clarifications, but avoid re-teaching in depth unless a common gap appears.
:::
...
**Instructor Notes:** Before starting the activity, clear out any doubts on the concept of 'power'. Encourage students to reason intuitively. The goal is not to have the right answer, but to reason by themselves first. 
...
:::incremental
1. **Prevents underpowered studies**: It makes sure you do not do an experiment that’s too small and miss something real.

2. **Saves time and effort**: Helps you figure out the smallest number of times you need to do your experiment to have a good chance. This way, you don’t waste time or resources.

3. **Required for transparency and publication**: Evidence that your experimental plan is thought through.
:::
...
1. It can help us avoid studies that are simply too weak to be useful. If a study is underpowered, you might run the experiment, analyse the data, and still fail to detect a real effect, not because the effect isn’t there, but because the study was too small.
...
3. Finally, power analysis is increasingly expected for transparency and publication. Many journals and ethics committees want to see that researchers planned their study carefully and that the sample size wasn’t chosen arbitrarily. Showing a power analysis is one way to demonstrate that your research design is solid and justified.
...
**Accessibility Tips**: The technical terms may be overwhelming for some of the learners - so they need to be clarified with simpler explanations.
:::

---

## Connecting simulations and power analysis

Two ways of performing power analysis:
...
<div style="font-size: 0.5em; color: red;">
Can you rephrase the these two ways to highlight more the contrast between the two? As a reader, I am currently not sure why you are arguing for the second method (although in the notes you are). 
</div>
...
:::incremental
- **Simulations = safe playground**: You try your study many times with pretend data, so you learn how your stats behave before touching real data.
