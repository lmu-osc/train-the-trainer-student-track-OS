...
<div style="font-size: 0.6em;">
<span style="color:red">Perhaps make this slide more conceptual about function arguments and then introduce the round function as a repetition on the next slide? This slide also feels quite full? Beth: agreed... done! SARA COMMENT: Current presenter notes read more like instructor notes - check and reformat.  </span>
</div>
...
If you really want to keep the c() function as an introductory example, we should make sure to reference back to these slides when we get to vectors.
