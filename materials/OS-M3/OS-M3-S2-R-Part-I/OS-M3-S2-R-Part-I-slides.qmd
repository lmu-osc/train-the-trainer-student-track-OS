...
- I adjusted image sizes on slides 15 and 26 for improved layout - thanks!
- Slide 43 ("Practical exercise 2: Solutions"): There is a placeholder speaker note ("ADD HERE") that has to be updated. - thanks! Feel free to add the presenter notes (unsure if we need instructor notes here?)
- Slide 14 ("What is R"): Red strikethrough text ("Would you want to add a hyperlink here?") is still there and needs to be removed. SvG: yes, more of those - no worries, we often keep those around until we implemented all of them, but thanks for having this on your radar!
- Should we all be included in the contribution statement? SvG: of course, I made a start - check the formatting for me or Luz and add your details :)
