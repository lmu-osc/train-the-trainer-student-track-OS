...
::: {.notes}
**Presenter Notes**:
For the practical exercise, create a new R script, write a comment in the first line using the hash symbol, and save it in a new folder dedicated to this course.
:::
...
>>>>>>> d101b00 (added content, practical activities, and missing sections)
:::
...
- Added key terms + definitions section (Slides 11-12), pre-break quiz (Slides 23-28), 15 minute break (i put it where I thought was appropriate to break up the lesson), post-break quiz discussion (31)
- Slide 14 - I added a column here because I thought the image was too small. What do you think?
- Slide 22: i don't think "Important data types" needs to be a level 1 heading if there will only be 2 slides addressing the topic - I leave this up to you! Beth: i changed it to level 2 heading and used it to make a new slide/new content (see Slide 20) ✅

---

## Feedback Beth

- Added content to 'objects and assignments' (Slide 35)
- Added Practical activities 3 (Slide 34), 4 (Slide 36), and 5 (Slide 39)
- Reworked post-session survey
